...
async def create_qualification(qualification_input: qualification_schema.CreateQualification, db: Session = Depends(get_db_connection)):
...
async def udpate_qualification(qualification_id: int, qualification_input: qualification_schema.CreateQualification, db: Session = Depends(get_db_connection)):
