...
async def create_employment_logs(employment_log_input: employment_log_schema.CreateEmploymentLog,
...
async def update_employment_logs(employment_log_id: int,
                                 employment_log_input: employment_log_schema.CreateEmploymentLog,
                                 db: Session = Depends(get_db_connection)):
    return employment_log_service.create_or_update_employment_log(db, employment_log_input, employment_log_id)


@router.delete("/{employment_log_id}", response_model=employment_log_schema.EmploymentLog,
